...
public class HomeStartPagerAdapter extends RecyclerView.Adapter<HomeStartPagerAdapter.ItemViewHolder> {
    ...
    public HomeStartPagerAdapter(List<HomeStartItems> homeStartItemsList) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        HomeStartItems currentItem = homeStartItemsList.get(position);
        holder.homeStartRating.setText(currentItem.getHomeStartRating());
        holder.homeStartTitle.setText(currentItem.getHomeStartTitle());
