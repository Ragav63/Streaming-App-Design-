...
public class MovieScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (popularMovieItemsList.isEmpty()) {
        ...
        if (popularMovieItemsList == null) {
            ...
            Log.d("MovieScreenActivity", "popularMovieItemsList size: " + popularMovieItemsList.size());
        }
                ...
                if (fragment == null) {
                    switch (position) {
                        case 0:
                            ...
                            break;
                        case 1:
                            fragment = MoreLikeThisFragment.newInstanceWithMovies(popularMovieItemsList);
                            break;
                        case 2:
                            fragment = AboutFragment.newInstanceWithMovies(popularMovieItemsList);
                            break;
                    }
