...
public class HomeStartCardRecItemAdapter extends RecyclerView.Adapter<HomeStartCardRecItemAdapter.ItemViewHolder> {
    ...
    private List<HomeStartCardListItems> itemList;
    ...
    public HomeStartCardRecItemAdapter(List<HomeStartCardListItems> itemList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        HomeStartCardListItems item = itemList.get(position);
